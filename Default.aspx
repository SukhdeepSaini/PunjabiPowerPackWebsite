...
<div class="navbar navbar-inverse navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container">
      ...
      <a class="brand" href="http://sukhdeeepsaini.comoj.com/" target="_blank">Sukhdeep Singh Saini</a>
...
<header>
	...
	<p>Welcome to my personal website . I am developing this website for my Web developement Course CS 5610 . This website will soon have some pretty interesting stuff.

    <br />        <a href="story/index.htm?Experiments/Project/Project.txt" target="_blank">Projects</a>
   <br /> <a href="story/index.htm?Experiments/Project/Documentation/Documentation.txt" target="_blank">Project Documentation</a></p>
</header>
	...
	<div id="myCarousel" class="carousel slide">
	  <!-- Carousel items -->
		<div class="carousel-inner">
            ...
            <div class="item"><img src="images/MyWebImages/perfect.jpg" alt="Car Carousel" width="100%" /></div>
  ...
  <!-- Example row of columns -->
    ...
    <a href="story/index.htm?Experiments/Project/Project.txt" target="_blank"><h1>Projects</h1></a>
    </div> <!-- /container -->
